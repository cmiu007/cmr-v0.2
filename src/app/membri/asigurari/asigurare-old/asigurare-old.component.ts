...
@Component({
  selector: 'app-asigurare-old',
  templateUrl: './asigurare-old.component.html',
  styleUrls: ['./asigurare-old.component.css']
})
export class AsigurareOldComponent implements OnInit {
